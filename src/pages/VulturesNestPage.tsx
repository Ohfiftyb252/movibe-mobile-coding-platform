...
export function VulturesNestPage() {
  ...
  }, [gameState?.winner, gameStage, betAmount, recordLoss, setOvCoin, resetLosses]);
  return (
    <OVWLayout>
      <div className="flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <UICard className="w-full max-w-6xl mx-auto bg-green-900/10 border-ov-primary/20 p-4 relative z-10">
          {gameStage === 'betting' ? (
